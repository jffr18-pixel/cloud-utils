...
_ALIAS_TIPO_DOC = {
    ...
    "tie":                ["tie"],
    "dni":                ["dni"],
    # El empadronamiento (incluido el historico) acredita presencia y permanencia
    ...
    # Documentos laborales tambien acreditan presencia/permanencia en España
    "vida_laboral":       ["vida_laboral",
                           "prueba_presencia_antes_2026", "prueba_permanencia_5_meses",
    ...
    "nomina":             ["nomina", "documentacion_empresa",
                           "prueba_presencia_antes_2026", "prueba_permanencia_5_meses",
                           "prueba_permanencia_2"],
    # El informe/certificado de vulnerabilidad social lo emiten los servicios
    # sociales: el OCR lo clasifica como informe_arraigo
    "informe_arraigo":    ["informe_integracion", "circunstancia_vulnerabilidad"],
    ...
    # Un certificado escolar tambien acredita presencia en España
